...
existing printable-message floor. Normal suggestions are subject-only. Thus a
repository that requires a body intentionally gets no normal candidate until
the later secondary body-composition flow can meet that policy.
